...
def test_favorite_color_expected_use1():
    ...
    test_dict = {'a': 'red', 'b': 'red', 'c': 'green', 'd': 'blue', 'e': 'red', 'f': 'red', 'g': 'green', 'h': 'blue',}
...
def test_favorite_color_expected_use2():
    ...
    test_dict = {'a': 'red', 'b': 'red', 'c': 'green', 'd': 'green',}
    results = favorite_color(test_dict)
    assert results == 'red'
